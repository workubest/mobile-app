...
function seedUsers(ss) {
  ...
  const users = [
    ...
    ['USER-002', 'Tigist Haile', 'manager@eeu.gov.et', 'manager123', 'manager', 'Oromia', 'Adama Service Center', '+251911234568', true, false, 0, '', 0, new Date().toISOString(), new Date().toISOString(), 'system', ''],
    ['USER-003', 'Mekdes Tadesse', 'staff@eeu.gov.et', 'staff123', 'staff', 'Amhara', 'Bahir Dar Service Center', '+251911234569', true, false, 0, '', 0, new Date().toISOString(), new Date().toISOString(), 'system', ''],
    ['USER-004', 'Dawit Assefa', 'customer@eeu.gov.et', 'customer123', 'customer', 'Addis Ababa', 'Bole Service Center', '+251911234570', true, false, 0, '', 0, new Date().toISOString(), new Date().toISOString(), 'system', ''],
    ['USER-005', 'Hanan Mohammed', 'technician@eeu.gov.et', 'tech123', 'technician', 'Dire Dawa', 'Dire Dawa Service Center', '+251911234571', true, false, 0, '', 0, new Date().toISOString(), new Date().toISOString(), 'system', '']
  ];
